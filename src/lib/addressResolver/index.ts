// Main address resolver - orchestrates API calls and fallback parsing
import { getGoogleMapsApiKey, isGooglePlacesAvailable } from './config';
import { parseAddressManually } from './parsing';
import { getPlaceSuggestions, getPlaceDetails } from './api';
import type { AddressType, PlaceSuggestion } from './types';

export type { AddressType, PlaceSuggestion };
export { isGooglePlacesAvailable };
...
export { getPlaceSuggestions, getPlaceDetails };
